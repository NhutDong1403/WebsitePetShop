...
export const FooterReptile = () => {
  return (
    <>
      <footer
        className="
          bg-lime-700 text-base-content p-6 sm:p-10 rounded-t-lg
          flex flex-col gap-8
      ...
      >
        ...
        <aside className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <p>
            ...
            <br />
            <span className="block text-sm text-white leading-relaxed text-justify max-w-xs mt-2">
        ...
        {/* Dịch vụ */}
        <nav className="flex flex-col items-center md:items-start border-t md:border-none pt-4 md:pt-0 text-white">
          <h6 className="text-lg sm:text-2xl font-bold uppercase tracking-wide text-amber-400 mb-2">
            Dịch vụ
          </h6>
          <Link to="/cham-soc-bo-sat" className="link link-hover mt-1">
            Dịch vụ chăm hộ
          </Link>
          <Link to="/dich-vu-bo-sat" className="link link-hover mt-1">
        ...
        <nav className="flex flex-col items-center md:items-start border-t md:border-none pt-4 md:pt-0 text-white">
          ...
          <div className="flex items-center gap-2 my-2">
            <img
              src="/images/Reptile/ContactReptile.gif"
              alt="Phone"
              className="w-10 h-10"
            />
          ...
          <div className="flex items-center gap-2 my-2">
            <img
              src="/images/Reptile/GmailReptile.gif"
              alt="Gmail"
              className="w-10 h-10"
            />
            <span className="text-lg sm:text-xl font-semibold text-brown-800">
