...
export const FooterRodent = () => {
  return (
    <>
      <footer
        className="
          bg-yellow-100 text-base-content p-6 sm:p-10 rounded-t-lg
          flex flex-col gap-8
      ...
      >
        ...
        <nav className="flex flex-col items-center md:items-start border-t md:border-none pt-4 md:pt-0 text-black">
          ...
          <div className="flex items-center gap-2 my-2">
            <img
              src="/images/Rodent/ContactRodent.gif"
              alt="Phone"
              className="w-10 h-10"
            />
          ...
          <div className="flex items-center gap-2 my-2">
            <img
              src="/images/Rodent/GmailRodent.gif"
              alt="Gmail"
              className="w-10 h-10"
            />
            <span className="text-lg sm:text-xl font-semibold text-brown-800">
