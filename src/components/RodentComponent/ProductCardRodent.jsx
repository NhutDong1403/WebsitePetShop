    ...
    <Link className="select-none" to={`/san-pham/${id}`}>
      <div className="card rounded-xl bg-stone-100 shadow-lg hover:shadow-xl transition w-full text-sm font-semibold py-5 px-5 h-[460px] flex flex-col justify-between">
        ...
        <div className="card-body p-4">
          ...
          <Link
            className="relative group btn btn-outline bg-yellow-700 text-white border-2 border-black btn-sm mt-2 overflow-hidden rounded-xl border-2 hover:border-black"
            to="/gio-hang-gam-nham"
          >
            <span className="absolute inset-0 w-0 group-hover:w-full transition-all duration-500 bg-yellow-800"></span>
...
export default ProductCardRodent;
