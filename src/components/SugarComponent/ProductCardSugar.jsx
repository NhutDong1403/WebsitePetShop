    ...
    <Link className="select-none" to={`/san-pham/${id}`}>
      <div className="card rounded-xl bg-stone-100 shadow-lg hover:shadow-xl transition w-full text-sm font-semibold py-5 px-5 h-[460px] flex flex-col justify-between">
        ...
        <div className="card-body p-4">
          ...
          <Link
            className="relative group btn btn-outline bg-gray-500 btn-sm mt-2 overflow-hidden text-white rounded-xl border-2 border-black hover:border-black"
            to="/gio-hang-bo-sat"
          >
            <span className="absolute inset-0 w-0 group-hover:w-full transition-all duration-500 bg-gray-700"></span>
...
export default ProductCardSugar;
