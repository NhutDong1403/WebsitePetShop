  ...
  return (
    <div className="select-none">
        ...
        >
          ...
          <div className="relative w-full">
            <input
              type="text"
              name="name"
              placeholder="Tên phụ kiện bò sát"
              value={formData.name}
      ...
      focus:ring-2 focus:ring-lime-700 focus:border-lime-700 outline-none transition flex justify-start items-center relative"
            >
              {formData.type || "Chọn loại phụ kiện bò sát"}
            ...
            {openTypeDropdown && (
              <ul className="absolute font-semibold left-0 mt-1 w-full bg-lime-50 border-4 border-lime-700 rounded-xl shadow-lg z-50 max-h-48 overflow-y-auto text-lg">
                {[
                  "Tank kính cho bò sát",
                  "Tank nhựa cho bò sát",
                  "Tank mica cho bò sát",
                  "Tank acrylic cho bò sát",
                  "Chén nước cho bò sát",
                  "Đèn sưởi cho bò sát",
                  "Đo nhiệt độ & độ ẩm cho bò sát",
                  "Đồ trang trí cho bò sát",
                  "Hang trú cho bò sát",
          ...
          <textarea
            name="description"
            placeholder="Mô tả phụ kiện bò sát"
            value={formData.description}
            onChange={handleChange}
            className="border-2 border-black text-lg rounded-xl px-4 py-3 col-span-2 focus:outline-none focus:ring-2 focus:ring-lime-700 focus:border-lime-700 w-full transition resize-none h-24"
          />
          ...
          <button
            type="submit"
            className="col-span-2 border-2 border-black text-lg bg-lime-700 text-white rounded-2xl py-3 font-semibold hover:bg-lime-600 shadow-md transition flex justify-center items-center space-x-2"
          >
            <span>Thêm phụ kiện bò sát</span>
          </button>
        </form>
        ...
        <div>
          <h3 className="text-3xl font-bold mb-6 text-lime-700">
            Danh sách phụ kiện bò sát
          </h3>
          {Object.keys(groupedProducts).length === 0 ? (
            <p className="text-gray-500 text-center text-lg">
              Chưa có phụ kiện bò sát nào được thêm.
            </p>
          ) : (
...
export default ThemPhuKienBoSat;
