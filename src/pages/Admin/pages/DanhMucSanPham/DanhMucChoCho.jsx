    ...
    <>
      ...
      <div className="max-w-7xl mx-auto mt-5 px-4 sm:px-6">
        <Breadcrumbs
          links={[
            ...
            { name: "Quản lý danh mục phụ kiện cho chó", to: "/Admin/danh-muc-cho-cho" },
          ]}
        />
      </div>
      ...
      <div className="max-w-xs sm:max-w-md md:max-w-4xl mx-auto mb-10 p-4 sm:p-6 border-2 border-black bg-pink-100 rounded-xl shadow-md mt-6">
        <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 text-pink-800">
          Quản lý danh mục phụ kiện cho chó
        </h2>
        ...
        >
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full sm:w-auto px-6 py-2 border-2 border-black font-semibold bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        {/* Danh sách danh mục */}
        {isFetching ? (
          <p className="text-center text-black">Đang tải danh mục...</p>
