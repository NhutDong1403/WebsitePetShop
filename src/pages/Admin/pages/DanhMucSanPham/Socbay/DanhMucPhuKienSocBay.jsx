...
export const DanhMucPhuKienSocBay = () => {
      ...
      <div className="max-w-7xl mx-auto mt-5 px-4 sm:px-6">
        <Breadcrumbs
          links={[
            ...
            { name: "Quản lý danh mục phụ kiện sóc bay", to: "/Admin/danh-muc-phu-kien-gam-nham" },
          ]}
        />
      </div>

      <div className="max-w-xs sm:max-w-md md:max-w-4xl mx-auto mb-10 p-4 sm:p-6 border-2 border-black bg-gray-100 rounded-xl shadow-md mt-6">
        <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 text-gray-800">
          Quản lý danh mục phụ kiện sóc bay
        </h2>
        ...
        >
          ...
          <button
            type="submit"
            className="w-full sm:w-auto px-6 py-2 border-2 border-black font-semibold bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition"
          >
            Thêm
          </button>
        </form>
        ...
        {danhSachDanhMuc.length === 0 ? (
          ...
          <ul className="space-y-3">
            {danhSachDanhMuc.map((dm, index) => (
              <li
                key={index}
                className="flex justify-between items-center px-4 py-2 bg-gray-200 border border-gray-200 rounded-lg shadow-sm"
              >
...
export default DanhMucPhuKienSocBay;
