...
export const CartPageRodent = () => {
  const [cartItems, setCartItems] = useState([
    {
      id: 1,
      name: "Thức ăn cho chuột hamster",
      image: "/images/Rodent/thucanchuot.png",
      price: 120000,
      quantity: 1,
      description: "Thức ăn dinh dưỡng dành riêng cho chuột hamster.",
    },
    {
      id: 2,
      name: "Lồng chuột cảnh",
      image: "/images/Rodent/longchuot.png",
      price: 350000,
      quantity: 2,
      description: "Lồng rộng rãi, có bánh xe quay và chỗ ngủ cho chuột.",
    },
  ]);
    ...
    <div className="select-none">
      ...
      <div className="min-h-screen bg-yellow-50 px-4 py-10">
        <div className="max-w-6xl mx-auto">
          ...
          {cartItems.length === 0 ? (
            <div className="alert alert-info shadow-lg bg-amber-100 border border-amber-300 text-black">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 space-y-4">
                <div className="bg-amber-300/30 shadow-md rounded-2xl p-3">
                ...
                {cartItems.map((item) => (
                  <div
                    key={item.id}
                    className="flex bg-white shadow-md rounded-lg border border-amber-200 p-4"
                  >
                    <figure
                    ...
                    <div className="flex-1 px-4 flex flex-col justify-center">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center border rounded-md border-black">
                          <button
                            className="px-2 py-1 text-lg font-bold text-amber-700 hover:text-black"
                ...
                <div className="collapse bg-yellow-100 border border-gray-200 rounded-lg">
                  ...
                  <div className="collapse-content peer-checked:max-h-screen max-h-0 overflow-hidden transition-all duration-300 text-sm space-y-4 pt-2">
                    ...
                    <button className="btn border-2 border-black bg-yellow-600 hover:bg-yellow-700 text-white mt-2">
                      Lưu thông tin
                    </button>
                  </div>
                </div>
      ...
      >
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
            {selectedItem && (
              <>
                <Dialog.Title className="flex justify-center text-2xl font-bold text-amber-700 mb-2">
                  {selectedItem.name}
                </Dialog.Title>
                <img
