...
export const DatLichChamHoRodent = () => {
  ...
  return (
    <div className="select-none">
      ...
      <div className="max-w-6xl mx-auto mt-5 px-4">
        <Breadcrumbs
          links={[
            { name: "Trang chủ gặm nhấm", to: "/san-pham-gam-nham" },
            { name: "Dịch vụ Spa", to: "/dich-vu-gam-nham" },
            { name: "Dịch vụ chăm hộ", to: "/cham-soc-gam-nham" },
      ...
      <div className="max-w-5xl mx-auto p-6">
        <h2 className="text-4xl font-bold mb-8 text-center text-yellow-700">
          🐭 Đặt Lịch Chăm Hộ Gặm Nhấm
        </h2>
          ...
          {packages.map((pkg) => (
            ...
            >
              <div className="flex justify-center items-center">
                <img
                  className="w-20 h-20 text-yellow-600 rounded-full border-2"
        ...
        >
          <h3 className="text-2xl font-bold mb-4 flex items-center gap-2 text-yellow-800">
          ...
          <div className="text-center mt-6">
            <button
              type="submit"
              className="px-6 py-3 bg-yellow-600 text-white font-semibold border-2 border-black rounded-xl hover:bg-yellow-600/80 transition"
            >
              Xác nhận đặt lịch
            </button>
          </div>
...
export default DatLichChamHoRodent;
