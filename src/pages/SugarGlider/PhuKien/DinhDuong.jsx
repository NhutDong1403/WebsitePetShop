      ...
      <div className="max-w-6xl mx-auto mt-5 px-4">
        <Breadcrumbs
          links={[
            ...
            { name: "Phụ kiện cho sóc bay", to: "/dinh-duong-cho-soc" },
            { name: "Dinh dưỡng cho sóc bay", to: "/dinh-duong-cho-soc" },
          ]}
        />{" "}
      </div>
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mt-4 mb-4">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold">Dinh Dưỡng Cho Sóc Bay</h2>
        </div>
