      ...
      <div className="max-w-6xl mx-auto mt-5 px-4">
        <Breadcrumbs
          links={[
            ...
            { name: "Phụ kiện cho sóc bay", to: "/tui-ngu-cho-soc" },
            { name: "Túi ngủ cho sóc bay", to: "/tui-ngu-cho-soc" },
          ]}
        />{" "}
      </div>
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mt-4 mb-4">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold">Túi Ngủ Cho Sóc Bay</h2>
        </div>
