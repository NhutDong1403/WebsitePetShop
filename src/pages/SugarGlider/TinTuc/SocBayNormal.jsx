...
const SocBayNormal = () => {
  const gallery = [
    "/images/SugarGlider/socbay/normal.jpg",
    "/images/SugarGlider/socbay/normal2.jpg",
    "/images/SugarGlider/socbay/normal3.jpg",
  ];
  ...
  const quickInfo = [
    {
      ...
      label: "Màu lông",
      value: "Xám nâu, bụng trắng",
    },
    {
      icon: <FaSmile className="text-gray-500 text-xl" />,
      label: "Tính cách",
      value: "Thân thiện, hoạt bát",
    },
    {
      ...
      <main className="max-w-6xl mx-auto px-3 sm:px-4 py-6 sm:py-10">
        <Breadcrumbs
          links={[
            ...
            { name: "Sóc bay Normal", to: "/soc-bay-normal" },
          ]}
        />
        ...
        <div className="relative rounded-2xl overflow-hidden shadow-lg mb-10">
          <img
            src="/images/SugarGlider/socbay/normal.jpg"
            alt="Sóc Bay Normal"
        ...
        {/* Mô tả chi tiết */}
        <section className="mb-10 space-y-3 text-gray-700 leading-relaxed text-base sm:text-lg px-1 sm:px-0">
          <p>
            Sóc Bay Normal có bộ lông màu xám nâu tự nhiên, phần bụng trắng và
            sọc đen chạy dọc từ mũi đến đuôi. Đây là màu sắc nguyên bản của
            Sugar Glider trong tự nhiên.
          </p>
          <p>
            Chúng rất thân thiện, dễ dàng làm quen với chủ nếu được chăm sóc và
            tương tác thường xuyên. Đặc biệt, Sóc Bay Normal có tuổi thọ cao,
            thường từ 10–15 năm khi được nuôi dưỡng đúng cách.
          </p>
          <p>
            Đây là lựa chọn lý tưởng cho những người mới bắt đầu nuôi sóc bay
            bởi tính cách dễ chịu và giá thành hợp lý hơn so với các dòng hiếm.
          </p>
        </section>
        ...
        <div className="bg-white border border-black rounded-xl shadow-lg p-4 sm:p-8 mb-10">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-600 mb-3 text-center">
            Thông Tin Nhanh Về Sóc Bay (Normal)
          </h2>
        ...
        <div className="mb-10">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-600 mb-4 text-center">
            Hình Ảnh Sóc Bay Normal
          </h2>
          <hr className="mb-5 w-20 sm:w-40 border-[2px] border-gray-600 mx-auto" />
          <div className="flex gap-4 overflow-x-auto sm:grid sm:grid-cols-2 md:grid-cols-3 sm:gap-4 scrollbar-hide">
            {gallery.map((src, idx) => (
              <div
                key={idx}
