...
export const CartPageWinger = () => {
  const [cartItems, setCartItems] = useState([
    {
      id: 1,
      name: "Thức ăn cho chim vẹt",
      image: "/images/Winger/birdfood.png",
      price: 120000,
      quantity: 1,
      description: "Thức ăn bổ dưỡng dành riêng cho chim vẹt.",
    },
    {
      id: 2,
      name: "Lồng chim cao cấp",
      image: "/images/Winger/longchim.png",
      price: 350000,
      quantity: 2,
      description: "Lồng chim tiện nghi, thoáng mát cho vẹt sinh hoạt.",
    },
  ]);
    ...
    <div className="select-none">
      ...
      <div className="min-h-screen bg-blue-50 px-4 py-10">
        <div className="max-w-6xl mx-auto">
          ...
          {cartItems.length === 0 ? (
            <div className="alert alert-info shadow-lg bg-blue-100 border border-blue-300 text-black">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 space-y-4">
                <div className="bg-blue-300/30 shadow-md rounded-2xl p-3">
                ...
                {cartItems.map((item) => (
                  <div
                    key={item.id}
                    className="flex bg-gray-300/30 shadow-md rounded-lg border border-black p-4"
                  >
                    <figure
                ...
                <div className="collapse bg-blue-100 border border-gray-200 rounded-lg">
                  ...
                  <div className="collapse-content peer-checked:max-h-screen max-h-0 overflow-hidden transition-all duration-300 text-sm space-y-4 pt-2">
                    ...
                    <button className="btn border-2 border-black bg-blue-400 hover:bg-blue-500 text-white mt-2">
                      Lưu thông tin
                    </button>
                  </div>
                </div>
